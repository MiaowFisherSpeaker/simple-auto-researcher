...
---
### 简单自动科研-openclaw skill | 一只虾的学术野心
...
autoresearcher 的定位，是一个**全自动学术研究助手**SKILL，核心理念是：**"搜→下→读→归档→想点子→验证"** 🔄，半条龙服务，躺平式科研体验！为你的小龙虾安装这个skill吧～
...
| 4 | 综述模板 | `GUIDELINES.md` | 📝 rethink 怎么写才像论文，自己好好修改哦 |

> 💡 **小贴士**：以上每一步都可以让 openclaw agent 帮你改，say 个 "帮我改 xxx" 就行，最好提一下autoresearcher。
...
|10|☑|bug|为了查看论文的情况，实际上要多和工作目录的papers.csv做联动，当前经常出现各个数量对应不上|
...
> **悄悄话:** 
> 
> 你：学弟这招太狠了，没有开箱即用环境，还要我自己配置小龙虾😡。结果配置了几天，少看了不少论文。
>
> 我：🤪（偷偷😈）
>
> 设备参考：Mac Mini 24G 512G